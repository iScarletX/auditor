...
// ===== 配置 =====
const INJECTED_DIR = '/Users/sixiang/KianWorkspace/.kian/main-agent/files/ws1-eval/injected/cover-agent-skill-INJECTED'
...
const outputPath = path.join(outDir, `cover-run-${stamp}.json`)
